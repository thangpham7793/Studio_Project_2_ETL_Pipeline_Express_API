<?php
 ...
 <main>
    ...
    <div class="sidebar">
      <div id="hideSidebar">
        <button type="button" class="close" data-toggle="collapse" data-target="#sidebarContent" onclick="toggleIcon()">
          <span id="toggleIcon" aria-hidden="true">^</span>
        </button>
      </div>

      <div id="sidebarContent" class="collapse show">
        <p id="instructions">Type address or click map to set location</p>
        <input class="sidebar_input" id="inputAddress" type="text" list="addressAutocomplete" placeholder="Delivery address..." onkeyup="enableSearch()">
